...
import {
  CafeneaSauLocalitate,
  ListaCafenele,
} from '../models/cafeneasaulocalitate';
...
export interface CafeneleSiCafele {
  id: string;
...
export class PseudoApiService {
  private cafele: ProdusDisponibil[] = [
    ...
    {
      id: 8,
      denumire: 'ETHIOPIAN YIRGACHEFFE',
      descriere:
    ...
    {
      id: 11,
      denumire: 'JAMAICAN BLUE MOUNTAIN',
      descriere:
  ...
  cafeneleSiCafele: CafeneleSiCafele[] = [
    {
      id: '8786',
      cafele: [
        this.cafele[7],
    ...
    {
      id: '1623',
      cafele: [this.cafele[9], this.cafele[7], this.cafele[6], this.cafele[0]],
    },
    {
      id: '1590',
      cafele: [
    ...
    {
      id: '8588',
      cafele: [this.cafele[5], this.cafele[2]],
    },
    {
      id: '864',
      cafele: [
    ...
    {
      id: '1927',
      cafele: [this.cafele[6], this.cafele[3]],
    },
    {
      id: '1784',
      cafele: [
    ...
    {
      id: '8382',
      cafele: [this.cafele[2], this.cafele[0], this.cafele[3], this.cafele[7]],
    },

    {
      id: '5492',
      cafele: [this.cafele[8], this.cafele[3]],
    },
    {
      id: '428',
      cafele: [
    ...
    {
      id: '9562',
      cafele: [this.cafele[3], this.cafele[8], this.cafele[1]],
    },
    {
      id: '6036',
      cafele: [
    ...
    {
      id: '5294',
      cafele: [this.cafele[2], this.cafele[7], this.cafele[6]],
    },
    ...
    {
      id: '8283',
      cafele: [this.cafele[3], this.cafele[1]],
    },
    {
      id: '1870',
      cafele: [
    ...
    {
      id: '8064',
      cafele: [this.cafele[0], this.cafele[6], this.cafele[2]],
    },
    {
      id: '5101',
      cafele: [
    ...
    {
      id: '8229',
      cafele: [this.cafele[6], this.cafele[1]],
    },
    {
      id: '4041',
      cafele: [
    ...
    {
      id: '5627',
      cafele: [this.cafele[6], this.cafele[8], this.cafele[0]],
    },
    {
      id: '9932',
      cafele: [this.cafele[4], this.cafele[7], this.cafele[0], this.cafele[1]],
    },
    {
      id: '2066',
      cafele: [this.cafele[1], this.cafele[7], this.cafele[9]],
    },
    {
      id: '4382',
      cafele: [this.cafele[8], this.cafele[0], this.cafele[3], this.cafele[5]],
    },
  ...
  private _cafeOrCitySubject = new BehaviorSubject<CafeneaSauLocalitate[]>(
    ListaCafenele.cafenele
  );
  private _coffeeSubject = new BehaviorSubject<CafeneleSiCafele[]>(
    this.cafeneleSiCafele
  );

  private _cafeleSubject = new BehaviorSubject<ProdusDisponibil[]>(this.cafele);

  cafeOrCity$ = this._cafeOrCitySubject.asObservable();
  ...
  getCafele$(): Observable<ProdusDisponibil[]> {
    return this._cafeleSubject;
  }

  getCoffee$(): Observable<CafeneleSiCafele[]> {
    return this._coffeeSubject;
  }

  getAvailableProductByCoffee(id: string): Observable<CafeneleSiCafele> {
    console.log(id);
    return this.getCoffee$().pipe(
      map((cafele: CafeneleSiCafele[]) =>
        cafele.find((cafea) => cafea.id === id)
      )
    );
  }

  getCafeaById(id: number): Observable<ProdusDisponibil> {
    console.log(id);
    return this.getCafele$().pipe(
      map((cafele: ProdusDisponibil[]) =>
        cafele.find((cafea) => cafea.id === id)
      )
    );
  }
  ...
  //         ]).pipe(delay(255));
  //       case 8588:
  //         return of([this.cafele[5], this.cafele[2]]).pipe(delay(314));
  //       case 864:
  //         return of([
  //           this.cafele[3],
  //           this.cafele[1],
  ...
  //         ]).pipe(delay(173));
  //       case 4371:
  //         return timer(818).pipe(
  //           mergeMap((e) =>
  //             throwError('Cafeneaua cu id 4371 ridica intentionat o exceptie.')
  //           )
  //         );
  //       case 1927:
  //         return of([this.cafele[6], this.cafele[3]]).pipe(delay(652));
  //       case 1784:
  //         return of([
  //           this.cafele[3],
  //           this.cafele[6],
  ...
  //         ]).pipe(delay(653));
  //       case 5492:
  //         return of([this.cafele[8], this.cafele[3]]).pipe(delay(922));
  //       case 428:
  //         return of([
  //           this.cafele[7],
  //           this.cafele[6],
  ...
  //         ]).pipe(delay(730));
  //       case 9562:
  //         return of([this.cafele[3], this.cafele[8], this.cafele[1]]).pipe(
  //           delay(245)
  //         );
  //       case 6036:
  //         return of([
  ...
  //         ]).pipe(delay(687));
  //       case 5294:
  //         return of([this.cafele[2], this.cafele[7], this.cafele[6]]).pipe(
  //           delay(984)
  //         );
  //       case 5703:
  //         return of([
  ...
  //         ]).pipe(delay(207));
  //       case 249:
  //         return timer(206).pipe(
  //           mergeMap((e) =>
  //             throwError('Cafeneaua cu id 249 ridica intentionat o exceptie.')
  //           )
  //         );
  //       case 7430:
  //         return of([
  ...
  //         ]).pipe(delay(439));
  //       case 8283:
  //         return of([this.cafele[3], this.cafele[1]]).pipe(delay(146));
  //       case 1870:
  //         return of([
  //           this.cafele[0],
  //           this.cafele[5],
  ...
  //         ]).pipe(delay(596));
  //       case 8064:
  //         return of([this.cafele[0], this.cafele[6], this.cafele[2]]).pipe(
  //           delay(172)
  //         );
  //       case 5101:
  //         return of([
  ...
  //         ]).pipe(delay(692));
  //       case 8229:
  //         return of([this.cafele[6], this.cafele[1]]).pipe(delay(648));
  //       case 4041:
  //         return of([
  //           this.cafele[6],
  //           this.cafele[5],
  ...
  //           mergeMap((e) =>
  //             throwError('Cafeneaua cu id 3062 ridica intentionat o exceptie.')
  //           )
  //         );
  //       case 1308:
  //         return timer(817).pipe(
  //           mergeMap((e) =>
  //             throwError('Cafeneaua cu id 1308 ridica intentionat o exceptie.')
  //           )
  //         );
  //       case 4513:
  //         return of([
  ...
  //         ]).pipe(delay(662));
  //       case 5627:
  //         return of([this.cafele[6], this.cafele[8], this.cafele[0]]).pipe(
  //           delay(208)
  //         );
  //       case 9932:
  //         return of([
  ...
  //         ]).pipe(delay(993));
  //       case 7516:
  //         return timer(523).pipe(
  //           mergeMap((e) =>
  //             throwError('Cafeneaua cu id 7516 ridica intentionat o exceptie.')
  //           )
  //         );
  //       case 3552:
  //         return timer(210).pipe(
  //           mergeMap((e) =>
  //             throwError('Cafeneaua cu id 3552 ridica intentionat o exceptie.')
  //           )
  //         );
  //       case 2066:
  //         return of([this.cafele[1], this.cafele[7], this.cafele[9]]).pipe(
  //           delay(342)
  //         );
  //       case 4382:
  //         return of([
  ...
  //           mergeMap((e) => throwError('Nu este un ID de cafenea'))
  //         );
  //     }
  //   }
}
